...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL,        KC_LGUI, KC_LALT,                                    KC_SPC,                    TO(_NUMPAD), MO(_FUN),   KC_LEFT,         KC_DOWN, KC_RGHT
    ),
    [_FUN] = LAYOUT(
    ...
    [_NUMPAD] = LAYOUT(
        ...
        _______, KC_P7,   KC_P8,   KC_P9,   _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,       _______, _______, _______,
        ...
        _______, KC_P0,   KC_PDOT,                            KC_PENT,                   KC_P0,   TO(_QWERTY), KC_PDOT, _______, _______
    ),
};
